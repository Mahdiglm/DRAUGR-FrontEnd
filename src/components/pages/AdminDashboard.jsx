              ...
              <ul>
                <li>
                  <button
                    ...
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'overview' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>داشبورد</span>
                ...
                <li>
                  <button
                    onClick={() => handleTabChange('users')}
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'users' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>کاربران</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                  <button
                    onClick={() => handleTabChange('orders')}
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'orders' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>سفارشات</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                ...
                <li>
                  <button
                    ...
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'products' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>محصولات</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                ...
                <li>
                  <button
                    ...
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'blogs' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>بلاگ</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1M19 8l-7 5-7-5m14 6a2 2 0 00-2 2v4a2 2 0 002 2h2a2 2 0 002-2v-4a2 2 0 00-2-2h-2z" />
                ...
                <li>
                  <button
                    ...
                    className={`w-full text-center px-4 py-2.5 mb-1 rounded-lg flex items-center justify-center
                      ${activeTab === 'settings' ? 'bg-draugr-700 text-white' : 'hover:bg-gray-800'}`}
                  >
                    <span>تنظیمات</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

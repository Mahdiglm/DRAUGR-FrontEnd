...
const Header = ({ cartItems, onCartClick }) => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      subcategories: [
        {
          name: "تخفیف‌های خون‌آشامی",
          items: ["۵۰٪ تخفیف محصولات خون‌آشامی", "خرید ۲ عدد، یکی رایگان", "ست های ویژه هالووین"]
        },
        {
          name: "کالکشن محدود",
          items: ["محصولات کمیاب", "آخرین موجودی‌ها", "ادیشن محدود"]
        },
        {
          name: "پیشنهاد شبانه",
          items: ["فقط امشب", "فروش نیمه‌شب", "پیشنهاد ساعت ۳ صبح"]
        }
      ]
    },
    {
